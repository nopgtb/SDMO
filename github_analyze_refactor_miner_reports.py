...
from common import relative_to_absolute, read_csv, write_csv, read_json
...
for mr in mined_repos:
    ...
    refactored_commits = mine_details_from_repo(mr, refactored_commits)
