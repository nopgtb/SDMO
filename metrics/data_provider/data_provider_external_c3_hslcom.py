...
from metrics.external_tools.external_c3_hslcom import C3_HSLCOM
...
class Data_Provider_External_C3_HSLCOM(Data_Provider_Interface):
    ...
    def pre_calc_run_external(self, repository, branch, commits_of_interest, analyze_only_commits_of_interest):
        if C3_HSLCOM.tool_present():
            ...
            Data_Calculator_Util.output_to_console("Expects c3_hslcom.py to be found at external_tools/c3_hslcom.py")

    #Try to read the result json file
    def read_results(self):
        #Read the external output
        self.c3_data = Data_Calculator_Util.read_json(C3_HSLCOM.get_output_path())
    ...
    def reset_data(self):
        ...
        self.external_tool_id = C3_HSLCOM.get_tool_id()
