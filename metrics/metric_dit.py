...
#DIT
#Depth of Inheritance Tree: the length of the path from a class to its farthest ancestor
class Metric_DIT(Metric_Interface):
    ...
    def get_metric(self, commit_hash):
        ...
        if metric_data and commit_hash in metric_data.keys():
            ...
            return {c["class"]:c["dit"] for c in metric_data[commit_hash]}
        return {}
