...
class Metric_NOSM(Metric_Interface):
    ...
    def get_metric(self, commit_hash):
        ...
        if metric_data and commit_hash in metric_data.keys():
            #for class in metric_data[hash] {class["class"] : class["staticMethodsQty"]}
            return [{"class":c["class"], "metric":c["staticMethodsQty"]} for c in metric_data[commit_hash]]
        return []
